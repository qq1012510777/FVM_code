...
/* MAIN */
/********/
void GPU_mat(double *h_A_dense, double *h_y, const int Nrows, const int Ncols)
{
    // --- Initialize cuSPARSE
    ...
    double *d_y;
    gpuErrchk(cudaMalloc(&d_y, Nrows * sizeof(double)));
    ...
    double *d_x;
    gpuErrchk(cudaMalloc(&d_x, Ncols * sizeof(double)));
