...
scatter(0.5, 0, 'o', 'k', 'filled');
hold on;
text(0.5, 0, '$E_3$', 'fontsize', 20, 'Interpreter', 'latex');
hold on;
...
hold on;
text(Triangle1(1, 1), Triangle1(1, 2), '$v_3$', 'fontsize', 20, 'Interpreter', 'latex');
hold on;
scatter(Triangle1(2, 1), Triangle1(2, 2), 'd', 'k', 'filled');
hold on;
text(Triangle1(2, 1), Triangle1(2, 2), '$v_1$', 'fontsize', 20, 'Interpreter', 'latex');
hold on;
scatter(Triangle1(3, 1), Triangle1(3, 2), 'd', 'k', 'filled');
hold on;
text(Triangle1(3, 1), Triangle1(3, 2), '$v_2$', 'fontsize', 20, 'Interpreter', 'latex');
